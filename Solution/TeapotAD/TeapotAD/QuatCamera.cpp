...
glm::quat fromAxisAngle(glm::vec3 axis, float angle) /*TODO:: Complete this function*/
{
	...
	rotation.x = axis.x * glm::sin(angle / 2);
	rotation.y = axis.y * glm::sin(angle / 2);
	rotation.z = axis.z * glm::sin(angle / 2);
...
{
	/*TODO:: Complete this function*/ //Week--7
	_orientation *= fromAxisAngle(_xaxis, -pitch);
	_orientation *= fromAxisAngle(WORLDY, -yaw);
...
{
	/*TODO:: Complete this function*/ //Week--7
	_orientation *= fromAxisAngle(_zaxis, z);
